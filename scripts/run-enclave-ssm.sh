...
# Run enclave with correct path and permissions
COMMANDS='[
    ...
    "nitro-cli run-enclave --cpu-count 2 --memory 1024 --eif-path /home/ec2-user/confidential-multi-agent-workflow/build/enclave.eif 2>&1 || echo ENCLAVE_FAILED",
    "sleep 3",
