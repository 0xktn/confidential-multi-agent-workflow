...
COMMAND_ID=$(aws ssm send-command \
    ...
    --parameters "commands=[\"echo '$TSK_CONTENT' > /home/ec2-user/confidential-multi-agent-workflow/encrypted-tsk.b64\",\"chmod 644 /home/ec2-user/confidential-multi-agent-workflow/encrypted-tsk.b64\",\"ls -la /home/ec2-user/confidential-multi-agent-workflow/encrypted-tsk.b64\"]" \
    --timeout-seconds 60 \
